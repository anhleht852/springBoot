      ...
      $('#comments').append(`<div class="single-post__comment__item">
           <div class="single-post__comment__item__pic">
            ...
            <div class="single-post__comment__item__text">
              <h5 id="u-${comment.commentId}">Người nhận xét: u-${comment.commentId}</h5>
              <span>Thời gian: ${comment.commentAt}</span>
              <p id="comment-content-${comment.commentId}">Nội dung:${comment.content}</p>
              ${editIcon}
            </div>
          </div>`
      );
