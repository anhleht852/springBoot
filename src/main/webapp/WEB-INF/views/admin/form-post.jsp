...
<%--&lt;%&ndash;                        <div class="col-md-6 form-group">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <label for="status">Status</label>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <select class="form-control" id="status">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <option value="1">Active</option>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <option value="0">InActive</option>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </select>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <div class="col-md-6 form-group">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <label for="rate">Rate <span id="rate-value">0</span></label>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <input class="form-control" id="rate" type="range" min="0" max="5" value="0"/>&ndash;%&gt;--%>
