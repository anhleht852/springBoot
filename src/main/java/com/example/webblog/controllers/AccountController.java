...
import com.example.webblog.servies.post.PostService;
...
public class AccountController {
    ...
    @GetMapping("/")
    public String showFormLogins(HttpServletRequest request ) {
        List<ImageSlide> imageSlides = (List<ImageSlide>) imageSlideService.findAll();
        List<PostRequest> id =(List<PostRequest>) postService.findAll();
