...
function showPostsToScreen(data){
 ...
 // Sắp xếp mảng data theo thứ tự giảm dần của thời gian tạo bài viết.
    ...
    data.forEach(function(post) {
        ...
        $('#data').append(
            `<div id="p-${totalElements}" class="col-lg-4 col-md-4 col-sm-4 ${hiddenClass}">
              <a href="/blog/single-post?id=${post.postId}">
                <div class="categories__post__item">

                    <div class="categories__post__item__pic small__item set-bg" style="background-image: url('${picture}');">
                    ...
                    <div class="categories__post__item__text">
                        ...
                        <ul class="post__widget">
                            <li>Người viết bài: <span>${author}</span></li>
                        </ul>
